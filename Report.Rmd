...
This graph indicates the total activity frequency for juvenile and adult squirrels during study period. The activity includes non-interactive and interactive with predators or human. 
...
This graphs show the frequency of squirrel's non-interactive and interactive activities with predators  or human in the park.
...
Overall, non-interactive activity counts were higher than interactive activity counts for the whole study period.There was an obvious decreasing trend on both activity counts during the last few days. 

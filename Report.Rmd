...
well traced and documented, but not always squirrels. However, the necessity of mapping the total population
...
In this project, we use [The Squirrel Census data](https://data.cityofnewyork.us/Environment/2018-Central-Park-Squirrel-Census-Squirrel-Data/vfnx-vebw) from NYC Open Data host, which focuses on Eastern gray species
...
1. [2018 Central Park Squirrel Census - Squirrel data](https://data.cityofnewyork.us/Environment/2018-Central-Park-Squirrel-Census-Squirrel-Data/vfnx-vebw)contains 

3023 squirrels' information,  including location coordinates, age, primary and secondary fur color, elevation, 
...
contains environmental data for the 350 “countable” hectares in Central Park, including temperature, litter, noise, 
...
degrees Fahrenheit, the number of squirrels observed drastically declined. Above 50, the 

change on rate of squirrel observed is not significant. 
...
Different from the boxplot, "temperature_fahrenheit" is a continuous variable in the model because we want to make full use of the dataset and increase the power of the hypothesis test. Consistent with the boxplot above, we have enough evidence to claim that there would be more squirrels observed when temperature is high, at 5% level of significance.
